...
import JournaldappIDL from '../target/idl/Journaldapp.json'
import type { Journaldapp } from '../target/types/Journaldapp'

// Re-export the generated IDL and type
export { Journaldapp, JournaldappIDL }

// The programId is imported from the program IDL.
export const JOURNALDAPP_PROGRAM_ID = new PublicKey(JournaldappIDL.address)
...
export function getJournaldappProgram(provider: AnchorProvider) {
  return new Program(JournaldappIDL as Journaldapp, provider)
}
